...
import com.yourDocuSmart.yourDocuSmart.domain.dto.AuthenticationRequest;
import com.yourDocuSmart.yourDocuSmart.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request) {
        try {
            ...
            UserDetails userDetails = yourDocuSmartUserDetailService.loadUserByUsername(request.getUsername());
